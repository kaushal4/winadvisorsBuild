...
import SimpleCards from "./homepage/SimpleCards";
...
class Main extends React.Component {
  ...
  componentDidMount() {
    ...
    this.addNum = document
      .querySelector(".addingNumbers")
    ...
    this.parallaxPseudo = window.getComputedStyle(
  ...
  handleScroll() {
    ...
    if (
      this.windowy * 0.9 + offset > this.addNum &&
      !this.state.activateWorldClients
    ) {
